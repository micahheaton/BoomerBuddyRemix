...
Record exact commands, timestamps, commit/tag identity, dirty-state before and after, and file/line or symbol anchors for every launch-critical claim. Define Customer 1 completion across acquisition, customer Clerk account, direct consent, household roles, orientation, one useful Check, optional deliberate Trusted Circle action, an explicit Family choice between the intended-default USD 149.90 annual offer after a seven-day trial and the USD 14.99 monthly offer without a trial, canonical provider-lifecycle entitlement, receipt, support, feedback, and authorized follow-up. A trialing annual subscription is not paid until its first verified `invoice.paid`; same-day settled-payment proof uses monthly. Classify each gap P0, launch-critical P1, other P1, or P2. Mark unknown facts as unknown and assign an owner and closure gate.
