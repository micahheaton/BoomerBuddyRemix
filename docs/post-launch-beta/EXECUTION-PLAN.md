...
or additional paid tier for the first cohort. Individual and referral candidates remain default-off
under [OFFER-HYPOTHESIS-REGISTRY.md](./OFFER-HYPOTHESIS-REGISTRY.md).
...
| Surface | Backlog item |
| --- | --- |
| Packaging | Keep Individual and referral hypotheses default-off; continue Family annual and monthly provider-lifecycle proof before either live initiation path opens |
