...
| Live Product and Price do not exist | Billing owner; founder approves write | One Family Product and one USD 14.99 monthly Price after an authorized write; no annual Price | Before live billing E2E and first payment | Stop if amount, currency, interval, quantity, or Product differs |
